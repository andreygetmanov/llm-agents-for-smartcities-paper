# Contributing to llm-agents-for-smartcities-paper

We welcome you to [check the existing issues](https://github.com/andreygetmanov/llm-agents-for-smartcities-paper/issues) for bugs or enhancements to work on.
If you have an idea for an extension to llm-agents-for-smartcities-paper, please [file a new issue](https://github.com/andreygetmanov/llm-agents-for-smartcities-paper/issues/new) so we can discuss it.

Make sure to familiarize yourself with the project layout before making any major contributions.

## How to contribute

1. Fork the [project repository](https://github.com/andreygetmanov/llm-agents-for-smartcities-paper/): click on the 'Fork' button near the top of the page. This creates a copy of the code under your account on the GitHub server.

2. Clone this copy to your local disk:

   ```bash
   git clone git@github.com:YourUsername/llm-agents-for-smartcities-paper.git
   ```
...
Finally, go to the web page of your fork of the llm-agents-for-smartcities-paper repo, and click
...
If your contribution changes llm-agents-for-smartcities-paper in any way:

- Update the [documentation](https://github.com/andreygetmanov/llm-agents-for-smartcities-paper/tree/main/chroma_rag/docs) so all of your changes are reflected there.

- Update the [README](https://github.com/andreygetmanov/llm-agents-for-smartcities-paper/tree/main/README.md) if anything there has changed.

If your contribution involves any code changes:

- Update the [project tests](https://github.com/andreygetmanov/llm-agents-for-smartcities-paper/tree/main/pipelines/tests) to test your code changes.
